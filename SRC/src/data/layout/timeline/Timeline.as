package data.layout.timeline 
{
	...
	public class Timeline extends Sprite
	{
		...
		public static const MODE_FILLING:String = "modeFilling";
		public static const MODE_CURSOR:String = "modeCursor";
		public static const DIR_HORIZONTAL:String = "dirHorizontal";
		public static const DIR_VERTICAL:String = "dirVertical";
		
		
		private var track:MovieClip;
		private var cursor:MovieClip;
		private var filling:MovieClip;
		private var filling2:MovieClip;
		...
		public function Timeline() 
		{
			track = track_stage;
			cursor = cursor_stage;
			filling = filling_stage;
			filling2 = filling2_stage;
			
			filling.mouseEnabled = false;
			filling.mouseChildren = false;
			filling2.mouseEnabled = false;
			filling2.mouseChildren = false;
		...
		public function init():void
		{
			...
			if (_uiMode == MODE_CURSOR) {
				...
				this.addEventListener(MouseEvent.MOUSE_UP, onReleaseCursor);
		...
		{
			filling2[_positionProp] = 0;
			filling2[_dimensionProp] = _trackSize * value;

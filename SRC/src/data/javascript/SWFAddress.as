...
package data.javascript{
    ...
    public class SWFAddress {
        ...
        private static function _initialize():Boolean {
			...
			//trace("SWFAddress._initialize(), availability : " + _availability);
		...
		/**
         * Provides the part of the address after the '#' (or null if no '#' found)
         */
		public static function getEndURL():String {
			var url:String = null;
            if (_availability)
                url = String(ExternalInterface.call('SWFAddress.getEndURL'));
            return (url == null || url == 'null' || !_availability) ? '' : url;
		}
		...
		static public function set availability(value:Boolean):void 
		{
			_availability = value;
		}
    }

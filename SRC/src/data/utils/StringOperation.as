package data.utils {
	...
	*/
	...
	public class StringOperation {
		...
		/**
		* Classe qui regroupe des méthodes de manipulation de chaine de caractères.
		* La classe StringOperation est statique.
		*/
		public function StringOperation() {
			throw new Error("Class StringOperation can't be instanciated. This class is static.");
		}
		...
		* Exemple : 
		* <div class="code">import data.utils.StringOperation
		* var email:String = "monsieurpatate&#64;photoshop.com";
		* trace(StringOperation.checkEmailValidity(email)); 
		...
		*/
		...
		/**
		* Fonction qui supprime les espaces, les tabulations et les retours chariot dans une chaine, au début et à la fin.
		...
		* trace(StringOperation.deleteSpace(chaineTraitee)); 
		...
		*/
		...
		/**
		* Fonction qui ajoute autant de charactères charAjout qu'il faut pour atteindre une chaine de longueur longueurChaineSouhaite
		* utilisée, par exemple, pour formater du texte pour une horloge.
		* Exemple : 
		* <div class="code">import data.utils.StringOperation
		* var chaineTraitee:String = "Coucou";
		* var nombrePetit:Number = 45;
		* trace(StringOperation.fillChar(chaineTraitee, 20, "!", "derriere")); 
		* <span class="commentaire">// Coucou!!!!!!!!!!!!!!</span>
		* trace(StringOperation.fillChar(nombrePetit.toString(), 5);
		...
		*/
		...
		/**
		* Fonction qui génère une chaine de caractères pris aléatoirement dans abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890
		* Exemple : 
		* <div class="code">import data.utils.StringOperation
		* trace(StringOperation.randomFill(5));
		* <span class="commentaire">// Kaf9e</span>
		* trace(StringOperation.randomFill(5));
		* <span class="commentaire">// 0r2Jz</span>
		* </div>
		* Remarque : si la longueur demandée est 0, la chaine retournée est "".
		* @param longueur longueur de la chaine qui doit être générée
		* @return chaine de caractère remplie de caractères.
		*/
		public static function randomFill(longueur:int):String {
			longueur = (longueur > 0)?longueur:0;
			var chars:String = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890";
			var retour:String = "";
			for(var i:int = 0; i<longueur; i++) {
				retour += chars.charAt(Math.random()*chars.length);
			}
			return retour;
		}
		...
		* Pour remplacer des chaines de plus d'un caractère, utilisez replaceChars(). Pour remplacer un seul caractère, privilégiez replaceChar() qui est plus optimisé.
		* Exemple : 
		* <div class="code">import data.utils.StringOperation
		* var chaineTraitee:String = "Bonjour tout le monde";
		* trace(StringOperation.replaceChar(chaineTraitee, "o", "O")); 
		...
		* La longueur de la chaine à remplacer et la longueur de la chaine remplaçante peuvent être différentes.
		...
		* trace(StringOperation.replaceChars(chaineTraitee, "Michel", "Robert")); 
		* <span class="commentaire">// Bonjour Robert, bonjour Rachelle. Merci de bien vouloir venir par ici Jean-Claude.</span>
		* trace(StringOperation.replaceChars(StringOperation.replaceChars(chaineTraitee, "Bonjour", "Au revoir"), "venir par ici", "vous assoir"));

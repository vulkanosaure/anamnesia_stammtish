/*
UTILISATION :
	import data.net.Ajax;
	var phpm:Ajax = new Ajax();
	phpm.call("fichier.php");
	phpm.addEventListener(Event.COMPLETE, onComplete);

INSERTION VARIABLES :
	//a faire avant l'appel de call()
...
package data2.net {
	...
	public class Ajax extends EventDispatcher{
		...
		public function call(_serverFile:String, _open:Boolean=false, _target:String=null, _method:String="POST"):void
		{
